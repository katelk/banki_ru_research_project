...
Отдельная находка: без денежного стимула banki.ru используется в основном как канал жалоб, что похоже на общий паттерн "доволен - промолчу, недоволен - напишу целенаправленно".
